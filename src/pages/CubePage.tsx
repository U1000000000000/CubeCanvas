  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute bottom-[calc(3rem+env(safe-area-inset-bottom))] sm:bottom-12 left-4 sm:left-6 pointer-events-auto"
          style={{ zIndex: 100 }}
        >
          <button
    ...
    `}
        ...
        <div
          className="absolute bottom-[calc(3rem+env(safe-area-inset-bottom))] sm:bottom-10 left-1/2 -translate-x-1/2 pointer-events-auto"
          style={{ zIndex: 100 }}
        >
