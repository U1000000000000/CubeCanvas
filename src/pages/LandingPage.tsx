              ...
              >
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-white/70">camera</div>
                  </div>
                </div>
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    ...
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-green-400 rounded-full flex items-center justify-center text-xs font-bold text-gray-900">
                      AI
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-white/80">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                ...
                <h4 className="font-semibold mb-2">AI Cube Scanning</h4>
                <p className="text-sm">Scan your physical cube with your camera and get AI-powered solutions</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
